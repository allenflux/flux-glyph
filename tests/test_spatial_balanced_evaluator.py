...
from training import evaluate_spatial_balanced as evaluator
...
def report_fixture(r21_passed=True, r22_passed=True):
    ...
    selection = {'trial': 'balanced-low', 'calibration_promotion_allowed': True, 'promotion_allowed': False,
                 'development_evaluated': False}
    parity = {'trial': 'balanced-low', 'passed': True, 'calibration_promotion_allowed': True,
