...
from training import export_unified_native_oe as export
from training.train_unified_native_oe import OBJECTIVE, STEPS, FAMILIES
...
def test_parity_schema_is_single_cnn_and_53_cal_checks():
    ...
    parity = export.build_parity_report(selection, '1' * 64, '2' * 64, '3' * 64, '4' * 64,
        ...
        [], measured, added)
    assert parity['schema'] == 'flux-glyph-unified-native-oe-onnx-parity-v1'
