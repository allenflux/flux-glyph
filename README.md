...
后续模型修复在本地进行。加宽网络、字重均衡和类别间距辅助训练分别通过 41、43、45／46 项保留验收。单向教师约束提高了覆盖，但只通过 40／46 项，文楷增权轮通过 45／46 项、文楷已达标，微米黑仍差 5 个样本达标，仍未替换 R21；正在补回微米黑覆盖。见[容量与字重修复记录](docs/unified-font-capacity-repair.md)。
