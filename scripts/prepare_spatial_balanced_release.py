...
SELECTION_SCHEMA = 'flux-glyph-spatial-balanced-selection-v1'
PARITY_SCHEMA = 'flux-glyph-spatial-balanced-onnx-parity-v1'
METADATA_SCHEMA = 'flux-glyph-unified-region-font-v1'
DEVELOPMENT_SCHEMA = 'flux-glyph-spatial-balanced-development-regression-v1'
FREEZE_SCHEMA = 'flux-glyph-spatial-balanced-development-freeze-v1'
EVIDENCE_SCHEMA = 'flux-glyph-spatial-balanced-release-evidence-v1'
SUPPORTED_SCHEMAS = {
    'flux-glyph-spatial-balanced-selection-v1': (
        'flux-glyph-spatial-balanced-onnx-parity-v1',
        'flux-glyph-spatial-balanced-development-regression-v1',
        'flux-glyph-spatial-balanced-development-freeze-v1'),
}
CAL_REGIONS = 18672
CAL_TILES = 37834
...
def _validate_cal(selection, parity, metadata):
    ...
    if selection['schema'] == 'flux-glyph-spatial-balanced-selection-v1':
...
def _validate_development(report, freeze, parity):
    ...
    require(parity.get('schema') == 'flux-glyph-spatial-balanced-onnx-parity-v1'
            and parity.get('trial') in ('balanced-low', 'balanced-medium', 'balanced-high')
