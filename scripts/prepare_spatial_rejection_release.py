...
SELECTION_SCHEMA = 'flux-glyph-spatial-rejection-selection-v1'
PARITY_SCHEMA = 'flux-glyph-spatial-rejection-onnx-parity-v1'
METADATA_SCHEMA = 'flux-glyph-unified-region-font-v1'
DEVELOPMENT_SCHEMA = 'flux-glyph-spatial-rejection-development-regression-v1'
FREEZE_SCHEMA = 'flux-glyph-spatial-rejection-development-freeze-v1'
EVIDENCE_SCHEMA = 'flux-glyph-spatial-rejection-release-evidence-v1'
SUPPORTED_SCHEMAS = {
    'flux-glyph-spatial-rejection-selection-v1': (
        'flux-glyph-spatial-rejection-onnx-parity-v1',
        'flux-glyph-spatial-rejection-development-regression-v1',
        'flux-glyph-spatial-rejection-development-freeze-v1'),
}
CAL_REGIONS = 18672
CAL_TILES = 37834
...
def _validate_cal(selection, parity, metadata):
    ...
    if selection['schema'] == 'flux-glyph-spatial-rejection-selection-v1':
...
def _validate_development(report, freeze, parity):
    ...
    require(parity.get('schema') == 'flux-glyph-spatial-rejection-onnx-parity-v1'
            and parity.get('trial') in ('rejection-low', 'rejection-medium', 'rejection-high')
