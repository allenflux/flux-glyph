#!/usr/bin/env python3
"""Prepare the spatial-rejection preview only after all unchanged CAL and DEV gates."""
...
SELECTION_SCHEMA = 'flux-glyph-spatial-refinement-selection-v1'
PARITY_SCHEMA = 'flux-glyph-spatial-refinement-onnx-parity-v1'
METADATA_SCHEMA = 'flux-glyph-unified-region-font-v1'
DEVELOPMENT_SCHEMA = 'flux-glyph-spatial-refinement-development-regression-v1'
FREEZE_SCHEMA = 'flux-glyph-spatial-refinement-development-freeze-v1'
EVIDENCE_SCHEMA = 'flux-glyph-spatial-refinement-release-evidence-v1'
SUPPORTED_SCHEMAS = {
    'flux-glyph-spatial-refinement-selection-v1': (
        'flux-glyph-spatial-refinement-onnx-parity-v1',
        'flux-glyph-spatial-refinement-development-regression-v1',
        'flux-glyph-spatial-refinement-development-freeze-v1'),
}
CAL_REGIONS = 18672
CAL_TILES = 37834
...
def _validate_cal(selection, parity, metadata):
    ...
    if selection['schema'] == 'flux-glyph-spatial-refinement-selection-v1':
        ...
        require(policy == NATIVE_MOBILE_ANDROID_GUARD_POLICY
                ...
                and selection.get('android_system_guard') == guard
                and selection.get('android_system_guard_baseline') == baseline,
...
def _validate_development(report, freeze, parity):
    ...
    require(parity.get('schema') == 'flux-glyph-spatial-refinement-onnx-parity-v1'
            and parity.get('trial') in ('refinement-low', 'refinement-medium', 'refinement-high')
            and candidate.get('trial_id') == parity['trial']
    ...
    require(report.get('android_system_guard_policy') == freeze.get('android_system_guard_policy')
            ...
            'Development evidence changed the Android system guard')
