...
from export_unified_native_oe import (CAL_REGIONS, METADATA_SCHEMA, PARITY_SCHEMA,
    STEPS, validate)
...
def build_development_report(selection, parity, measured, by_view, confusion, denominators,
    ...
    return {'schema': 'flux-glyph-unified-native-oe-development-regression-v1',
        ...
        'source_version_summaries': {
            ...
            'candidate': {'trial_id': 'native-oe-v1',
...
def evaluate(args):
    ...
    source_files = [Path(__file__), ROOT / 'training/export_unified_native_oe.py',
    ...
    freeze = {'schema': 'flux-glyph-unified-native-oe-development-freeze-v1',
