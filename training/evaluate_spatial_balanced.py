...
from scripts.prepare_spatial_balanced_release import validate_calibration_boundary
from export_spatial_balanced import (CAL_REGIONS, METADATA_SCHEMA, PARITY_SCHEMA,
    STEPS, validate)
...
def build_development_report(selection, parity, measured, by_view, confusion, denominators,
    ...
    require(selection.get('trial') in ('balanced-low', 'balanced-medium', 'balanced-high')
    ...
    return {'schema': 'flux-glyph-spatial-balanced-development-regression-v1',
...
def evaluate(args):
    ...
    source_files = [Path(__file__), ROOT / 'training/export_spatial_balanced.py',
        ROOT / 'scripts/prepare_spatial_balanced_release.py',
    ...
    freeze = {'schema': 'flux-glyph-spatial-balanced-development-freeze-v1',
