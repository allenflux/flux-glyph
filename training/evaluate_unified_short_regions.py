...
from export_unified_short_regions import (CAL_REGIONS, METADATA_SCHEMA, PARITY_SCHEMA,
    STEPS, validate)
...
def build_development_report(selection, parity, measured, by_view, confusion, denominators,
    ...
    return {'schema': 'flux-glyph-unified-short-development-regression-v1',
...
def evaluate(args):
    ...
    source_files = [Path(__file__), ROOT / 'training/export_unified_short_regions.py',
    ...
    freeze = {'schema': 'flux-glyph-unified-short-development-freeze-v1',
