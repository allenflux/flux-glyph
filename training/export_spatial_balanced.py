...
PLAN_SCHEMA = 'flux-glyph-spatial-balanced-plan-v1'
...
TRIALS = ('balanced-low', 'balanced-medium', 'balanced-high')
...
OBJECTIVE_SHA = '86e6db7b9a2b198643f2de9eff9f96f83907266380d3c4fa8371db053afe4a7b'
...
GRID_ROOT = ROOT / 'artifacts/unified-font-v7/balanced-plans-v1'
RUN_ROOT = ROOT / 'artifacts/unified-font-v7/balanced-runs-v1'
...
def validate(run, data, plan_path):
    ...
    require(result.get('schema') == 'flux-glyph-spatial-balanced-grid-result-v1'
    ...
    require(grid.get('schema') == 'flux-glyph-spatial-balanced-grid-v1'
    ...
    require(selection.get('schema') == 'flux-glyph-spatial-balanced-selection-v1'
            and protocol.get('schema') == 'flux-glyph-spatial-balanced-training-freeze-v1'
...
def export(args):
    ...
    source_files = [Path(__file__), ROOT/'training/evaluate_spatial_balanced.py',
        ROOT/'scripts/prepare_spatial_balanced_release.py', ROOT/'training/train_spatial_balanced.py',
