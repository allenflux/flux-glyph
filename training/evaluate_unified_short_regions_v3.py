...
from export_unified_short_regions_v3 import (CAL_REGIONS, METADATA_SCHEMA, PARITY_SCHEMA,
    STEPS, validate)
...
def build_development_report(selection, parity, measured, by_view, confusion, denominators,
    ...
    return {'schema': 'flux-glyph-unified-short-development-regression-v3',
        ...
        'source_version_summaries': {
            ...
            'candidate': {'version': 'r22-short-region-continuation-v3',
...
def evaluate(args):
    ...
    source_files = [Path(__file__), ROOT / 'training/export_unified_short_regions_v3.py',
    ...
    freeze = {'schema': 'flux-glyph-unified-short-development-freeze-v3',
